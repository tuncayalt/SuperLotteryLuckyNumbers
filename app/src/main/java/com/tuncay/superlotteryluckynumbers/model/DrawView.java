...
public class DrawView extends View {
    ...
    public DrawView(Context context) {
        ...
        colorballs.add(new ColorBall(context, R.drawable.top, point1));
        colorballs.add(new ColorBall(context, R.drawable.top, point2));
        colorballs.add(new ColorBall(context, R.drawable.top, point3));
        colorballs.add(new ColorBall(context, R.drawable.top, point4));
